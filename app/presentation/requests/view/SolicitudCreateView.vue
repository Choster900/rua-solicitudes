        ...
        <aside class="space-y-4">
          <article class="rounded-2xl border border-outline/20 bg-surface-container-lowest/5 p-4">
            ...
            <ul class="mt-3 space-y-2 text-sm text-outline-variant">
              <li class="flex items-start gap-2">
                <span class="material-symbols-outlined text-[18px] text-secondary-container">task_alt</span>
          ...
          <article class="rounded-2xl border border-outline/20 bg-surface-container-lowest/5 p-4">
            ...
            <p class="mt-2 text-sm text-outline-variant">
              Un brief completo reduce retrabajo, mejora tiempos de aprobación y acelera el paso a preprensa.
            </p>
          </article>
        </aside>
      </div>
...
import { createEmptyRequestFormModel, useRequestsModule } from '~/presentation/requests/composables/useRequestsModule'
