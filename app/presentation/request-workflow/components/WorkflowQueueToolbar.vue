<template>
    <section class="grid gap-4 lg:grid-cols-[minmax(0,1fr),auto]">
        ...
        <article class="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:w-[560px]">
            <WorkflowKpiCard
            ...
            <WorkflowKpiCard
                ...
                tone="warning"
            />
            <WorkflowKpiCard label="Aprobadas" :value="metrics.approved" tone="success" />
            <WorkflowKpiCard label="Vencidas SLA" :value="metrics.overdue" tone="danger" />
            <WorkflowKpiCard
