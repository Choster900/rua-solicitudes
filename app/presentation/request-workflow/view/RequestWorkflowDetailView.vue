        ...
        <aside class="space-y-4">
          <article class="rounded-2xl border border-outline/20 bg-surface-container-lowest/5 p-4">
            ...
            <p class="mt-2 text-sm text-outline-variant">
              {{ selectedRequest ? stageLabelMap[selectedRequest.stage] : 'Solicitud no encontrada' }}
            </p>
            <p class="mt-1 text-xs text-outline-variant">
              Última actualización: {{ selectedRequest ? formatDate(selectedRequest.updatedAt) : '-' }}
            </p>
          </article>
          ...
          <article class="rounded-2xl border border-outline/20 bg-surface-container-lowest/5 p-4">
            ...
            <ul class="mt-3 space-y-2 text-xs text-outline-variant">
              <li class="flex items-start gap-2">
                <span class="material-symbols-outlined text-[17px] text-secondary-container">check_circle</span>
